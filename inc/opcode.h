...
#define CODE_CB_SLRHL       (0b1100101100111110)        // 0xCB3E   // SLR (HL)
...
#define CODE_DDCB_SRLIXD    (0b11011101110010110000000000110110)     // SRL (IX+d)
...
#define CODE_FDCB_SRLIYD    (0b11111101110010110000000000110110)     // SRL (IY+d)
